    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Student Recoverable List</h4>
                <div class="flex-shrink-0">
                    <a href="{{ route('unpaid-students-list') }}" class="btn btn-info btn-label btn-sm">
                        <i class="ri-refresh-line label-icon align-middle fs-16 me-2"></i> Reload
                    </a>
                    <a href="{{ route('unpaid-students-export') }}" class="btn btn-info btn-label btn-sm">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        @role('super_admin|ho-accountant|manager-parent-relations|head-of-finance|manager-parent-relations|senior-manager-business-development|manager-business-development|deputy-director|ceo|manager-quality-assurance|manager-legal-affairs-litigation|senior-marketing-manager|marketing-manager')
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-label-group in-border">
                                    <select class="filter form-select load-select" id="state_id" name="state_id"
                                            data-target="branch_id" data-url="{{ route('list-branches-by-state') }}">
                                        <option value="">Please select</option>
                        ...
                        <div class="col-md-2 col-sm-12">
                            <div class="form-label-group in-border">
                                <select class="filter form-select load-select" id="class_id" name="class_id" data-target="section_id"
                                        data-url="{{ route('list-branch-classes-sections') }}">
                                    <option value="">Please select</option>
                                    @role('super_admin|ho-accountant|manager-parent-relations|head-of-finance|manager-parent-relations|senior-manager-business-development|manager-business-development|deputy-director|ceo|manager-quality-assurance|manager-legal-affairs-litigation|senior-marketing-manager|marketing-manager')
                    ...
                    <table id="unpaid-student-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                @role('super_admin|ho-accountant|manager-parent-relations|head-of-finance|manager-parent-relations|senior-manager-business-development|manager-business-development|deputy-director|ceo|manager-quality-assurance|manager-legal-affairs-litigation|senior-marketing-manager|marketing-manager')
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#unpaid-student-table').dataTable({
                searching: false,
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                ajax: {
                    url: "{{ route('unpaid-students-list') }}",
                    data: function(d) {
                        d.gender = $('#gender').val();
        ...
        $(document).on('change', '.filter', function() {
            $('#unpaid-student-table').DataTable().ajax.reload(null, false).page('first');
        });
