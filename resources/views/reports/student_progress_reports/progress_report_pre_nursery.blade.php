...
<head>
    ...
    <title>Pre-Nursery Progress Report</title>
    <style>
        /* table,
  th,
  td {
        ...
        <tr>
                ...
                <table class="table-img2">
                    <tr>
                        <td>
                            ...
                            <table style="margin-left:110px; position:relative;">
                                <tr style="width:100%; ">
                                    <td>
                                    ...
                                    <img src="{{asset('assets/img/1x/new-kids4.png')}}" style="position:absolute; " alt="">
                                </tr>
                                <tr>
                                    <td>
            ...
            <td>
                <table>
                    <tr>
                        <td style="position:relative;">
                            <img src="{{asset('assets/img/1x/Pre-nursery_1.png')}}" alt="">
                            <table class="table-img cover-table">
                                <tr>
                                    <td style="text-align: center;">
                                        ...
                                        <h3 style="color:#1e398d; margin-top: -10px; font-family:raleway, medium; font-size: 16px;;">Early Years: Pre Nursery</h3>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="all-text">
                                                        Names and identifies the following colours: red, yellow, blue.
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="all-text">
                                                    Enjoying colouring and painting.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: baseline;">
                                                ...
                                                <td class="all-text">
                                                    Tries to use a varierty of lines and shapes in artwork.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: baseline;">
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="all-text">
                                                        Responds to beats in simple musical composition.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="all-text">
                                                        Participates in role play activities.
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td class="all-text">
                                        Sorts and groups objects according to their sizes and shapes.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: baseline; ">
                                    ...
                                    <td class="all-text">
                                        Identifies the use of colours in traffic signals.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: baseline; ">
                                ...
                                <tr>
                                    ...
                                    <td class="all-text">
                                        Talks about the colours and shapes of things in the environment.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: baseline; ">
                                    ...
                                    <td class="all-text">
                                        Identifies the following parts of the body:
                                        <br>
                                        hands, shoulders, knees, toes, hands, feet.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: baseline; ">
                                    ...
                                    <td class="all-text">
                                        Recognises the following parts of a plant:
                                        <br>
                                        flower, leaves.
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="all-text">
                                        Uses vocabulary related to families, shopping and everyday things.
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <p class="all-text">
                                            Moves freely when crawling, hopping, jumping, and running.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="all-text">
                                        Walks down the steps, alternating feet.
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td class="all-text">
                                        Seperates from the main care giver with support.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: baseline; ">
                                ...
                                <tr>
                                    ...
                                    <td class="all-text">
                                        ...
                                        <table>
                                            <tr>
                                                <td class="all-text">
                                                    <input type="checkbox" name="" id=""> takes turns
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="all-text">
                                                    <input type="checkbox" name="" id=""> shares
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="all-text">
                                                    <input type="checkbox" name="" id=""> uses polite words e.g. Thank you, Please, Sorry, excuse me
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
