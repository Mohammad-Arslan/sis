...
<body>
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: center;">php
                            ...
                            <h3 style="color:#1e398d; margin-top: -10px; font-family:raleway, medium;">Early Years: Nursery</h3>
    ...
    <table style="width:100%; height:100%; margin-top:30px;">
        ...
        <img src="{{asset('assets/img/1x/kids2.png')}}" style="position:absolute; margin-top: 850px;  margin-left:350px; " alt="">
    </table>
    </td>
    </tr>
    </table>
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            ...
                            <h3 style="color:#1e398d; margin-top: -10px; font-family:raleway, medium;">Early Years: Kindergarten</h3>
                            <h5 style="margin-top: -10px;">ACADEMIC YEAR 20
                                <input type="number" style="width: 35px; border: none !important; border-bottom: 1px solid #000 !important;">
                                -
                                <input type="number" style="width: 35px; border: none !important; border-bottom: 1px solid #000 !important;">
