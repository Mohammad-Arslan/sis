...
<body>
  ...
  <table style="width:100%; height:100%;">
    <tr>
            ...
            <td>
              <table class="tbl-inputs">
                <tr>
                  ...
                  <img style="margin-left: 120px; margin-top:520px; position:absolute; " src="{{ asset('assets/img/1x/animate.png') }}">
                </tr>
              </table>
      ...
      <td>
        <p style="color: #1e398d; font-family: 'Roboto', sans-serif; font-weight: 800; font-size:16px; text-align:right; ">Punjab</p>
        <table>
          <tr>
            <td>
              ...
              <table class="table-img cover-table" style="margin-top:20px; margin-left:10px; width:40%;">
                <tr>
                  <td>
                    ...
                    <p style="color:#1e398d; text-align:center; margin-left:-10px; font-size: 22px; font-weight:500; margin-bottom:-25px;" class="montser-font">TERM I</p>
                    <h3 class="montser-font" style="color:#1e398d; font-weight:500; font-size:20px; text-align:center; margin-left:-10px;  ">Lower Primary</h3>
                    <h3 class="montser-font" style="color:#1e398d; font-weight:400; font-size:20px; text-align:center; margin-left:-10px; margin-top:-25px; ">Classes I-II</h3>
                    <h5 style="margin-top: -20px; margin-right:10px;  font-family: 'Open Sans', sans-serif; font-weight:500;">ACADEMIC YEAR
                      <h5 style=" margin-top:-25px; margin-right:15px;  font-family: 'Open Sans', sans-serif; font-size:14px; font-weight:500;">20
                        <input type=" number" style="width: 20px; margin-bottom:5px; border: none !important; margin-left:5px; border-bottom: 1px solid #000 !important;">
                        -
                        <input type="number" style="width: 20px; border: none !important; border-bottom: 1px solid #000 !important;">
                      </h5>
                    </h5>
                  </td>
                </tr>
          ...
          <tr>
            <td style="position:relative;">
              <table class="table-img cover-table">
                ...
                <table style="margin-left:75px; margin-top:-30px;">
                  <tr>
                    <td>
                ...
                <table style="margin-left:125px; margin-top:-30px;">
                  <tr>
                    <td>
          ...
          <img style=" width:100%; height:80vh; position:absolute; z-index:-1; " src="{{ asset('assets/img/1x/img-cld-1.png') }}">
        </table>
      </td>
    </tr>
  </table>
  ...
  <table>
    <tr style="vertical-align: baseline;">
      <td class="first-table">
        ...
        <br>
        <table style="width:100%; border: 1px solid grey; border-radius:5px; background-color:#edeeef;" class="single-border">
          <tr>
        ...
        <table style="width:100%; border: 1px solid grey; border-radius:5px;" class="single-border">
          ...
          <tr class="drk-blue-clr">
            ...
            <td style="font-weight: bolder !important;">20 <br> marks</td>
            <td style="font-weight: bolder !important;">20 <br> marks</td>
            <td style="font-weight: bolder !important;">30 <br> marks</td>
              ...
              <table class="tbl-inputs">
                <tr>
                  <td>
                    ...
                    <p class="all-text">Dated: <input class="input-border" type="text"></p>
                    <p style="font-weight:bolder;" class="all-text">Promoted/Not Promoted</p>
                  </td>
                  <img style="margin-left: 120px; margin-top:520px; position:absolute; " src="{{ asset('assets/img/1x/animate.png') }}">
  </tr>
  ...
  <td>
    <p style="color: #1e398d; font-family: 'Roboto', sans-serif; font-weight: 800; font-size:18px; text-align:right; ">Punjab</p>
    <table>
      <tr>
        <td>
          <img style="display:block;  margin:0 auto;" src="{{asset('assets/img/1x/ucs_logo.png')}}" alt="">
          ...
          <table class="table-img cover-table" style="margin-top:20px; margin-left:10px; width:40%;">
            <tr>
              <td>
                <p style="color:#1e398d; font-family: 'Roboto', sans-serif; font-size:22px; font-weight:900; text-align:center; margin-left:-10px; margin-top:-30px; margin-bottom:-8px; line-height: 0.5px;">PROGRESS</p>
                <p style="color:#1e398d; font-family:'Roboto', sans-serif; font-size:29px; font-weight:900; text-align:center; margin-left:-10px; margin-bottom:-10px; line-height:0.5px;">REPORT</p>
                <p style="color:#1e398d; text-align:center; margin-left:-10px; font-size: 22px; font-weight:500; margin-bottom:-25px;" class="montser-font">TERM II</p>
                <h3 class="montser-font" style="color:#1e398d; font-weight:500; font-size:20px; text-align:center; margin-left:-10px;  ">Lower Primary</h3>
                <h3 class="montser-font" style="color:#1e398d; font-weight:400; font-size:20px; text-align:center; margin-left:-10px; margin-top:-25px;  ">Classes I-II</h3>
                <h5 style="margin-top: -20px; margin-right:15px; font-family: 'Open Sans', sans-serif; font-weight:300;">ACADEMIC YEAR
                  <br>
                  <h5 style="margin-top: -25px;">20
                    <input type="number" style="width: 20px; margin-bottom:5px; border: none !important; margin-left:5px; border-bottom: 1px solid #000 !important;">
                    -
                    <input type="number" style="width: 20px; border: none !important; border-bottom: 1px solid #000 !important;">
                  </h5>
