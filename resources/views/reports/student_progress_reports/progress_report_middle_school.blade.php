...
<table style="width:100%; height:100%;">
  <tr>
    ...
    <td>
    <p style="color: #1e398d; font-family: 'Roboto', sans-serif; font-weight: 800; font-size:18px; text-align:right; margin-top:30px;">Punjab & Sindh</p>
      <table>
        <tr>
          <td>
            ...
            <table class="table-img cover-table" style="margin-top:20px; margin-left:10px; width:40%;">
              <tr>
                <td>
                  ...
                  <h3 class="montser-font" style="color:#1e398d; font-weight:500; font-size:20px; text-align:center; margin-left:-10px;  ">Middle School</h3>
        ...
        <img style=" width:100%; height:120vh; position:absolute; z-index:-1; " src="{{ asset('assets/img/1x/img-cld-2.png') }}">
      </table>
    </td>
  </tr>
</table>
  ...
  <tr style="vertical-align: baseline;">
    <td class="first-table">
      ...
      <table style="width:100%; border: 1px solid grey; border-radius:5px;" class="single-border">
        ...
        <tr>
          <th>Translation of the Holy Quran</th>
          <td></td>
          <td></td>
          <td></td>
          <td></td>
