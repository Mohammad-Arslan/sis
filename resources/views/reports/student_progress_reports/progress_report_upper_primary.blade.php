...
<table style="width:100%; height:100%;">
  <tr>
    ...
    <td>
    <p style="color: #1e398d; font-family: 'Roboto', sans-serif; font-weight: 800; font-size:18px; margin-top:20px; text-align:right; ">Punjab</p>
      <table>
        <tr>
          <td>
        ...
        <tr>
          <td style="text-align: center; position:relative;">
            ...
            <table class="table-img cover-table" style="margin-top:20px; margin-left:10px; width:40%;">
              <tr>
                <td>
                  <p style="color:#1e398d; font-family: 'Roboto', sans-serif; font-size:21px; font-weight:900; text-align:center; margin-left:-10px; margin-top:-30px; margin-bottom:-8px; line-height: 0.5px;">PROGRESS</p>
                  <p style="color:#1e398d; font-family:'Roboto', sans-serif; font-size:28px; font-weight:900; text-align:center; margin-left:-10px; margin-bottom:-12px; line-height:0.5px;">REPORT</p>
                  ...
                  <h3 class="montser-font" style="color:#1e398d; font-weight:400; font-size:20px; text-align:center; margin-left:-15px; margin-top:-22px; ">Classes III-V</h3>
                  <h5 style="margin-top: -25px; margin-left:25px;  font-family: 'Open Sans', sans-serif; font-weight:300;">ACADEMIC YEAR
                    <br>
                    <h5 style="margin-top: -25px; margin-left:35px;">20
                      <input type="number" style="width: 20px; margin-bottom:5px; border: none !important;  border-bottom: 1px solid #000 !important;">
                      -
