...
@section('content')
    ...
    <x-breadcrumb>
        ...
        <li class="breadcrumb-item">Scheme of Work</li>
    </x-breadcrumb>
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Scheme of Work</h4>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <table id="sow-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                       style="width:100%">
                    <thead>
                    <tr>
                        <th>Document Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#sow-data-table').DataTable({
                ...
                ajax: {
                    url: "{{ route('scheme_of_work.index') }}",
                    dataType: "json",
                    method: 'GET',
                    data: function(d) {
            ...
            $(document).on('change', '.filter', function() {
                $('#sow-data-table').DataTable().ajax.reload(null, false);
            });
        });
    </script>
@endpush
