<div class="col-lg-12">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Subject Remarks List</h4>
        </div><!-- end card header -->

        <div class="card-body">
            <table id="subject-remarks-datatable"
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#subject-remarks-datatable').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                bLengthChange: false,
                ...
                ajax: {
                    url: "{{ route('subject-remarks.index') }}",
                    dataType: "json",
                    method: 'GET',
                    data: function(d) {
            ...
            $(document).on('click', '.fetch_assessments', function() {
                ...
                $('#subject-remarks-datatable').DataTable().ajax.reload(null, false);
            });
        });
    </script>
@endpush
