        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Syllabus</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <table id="syllabusTable" class="table table-bordered table-striped align-middle table-nowrap mb-0" style="width:100%">
                        <thead>
                        <tr>
                            <th>Document Name</th>
                            <th>Academic Year</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#syllabusTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('general-document.syllabus.index') }}",
                    dataType: "json",
                    method: 'GET',
                    data: function(d) {
