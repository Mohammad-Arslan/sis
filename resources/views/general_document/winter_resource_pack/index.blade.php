        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Winter Resource Pack</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <table id="winterResourcePackTable"
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#winterResourcePackTable').DataTable({
                processing: true,
                serverSide: false,
                responsive: true,
                bLengthChange: false,
                ...
                ajax: {
                    url: "{{ route('general-document.winter-resource-pack.index') }}",
                    dataType: "json",
                    method: 'GET',
                    data: function(d) {
