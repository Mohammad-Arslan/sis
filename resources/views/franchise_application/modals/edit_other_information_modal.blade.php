<div class="modal fade" id="editOtherInfoModal" tabindex="-1" aria-labelledby="editOtherInfoModalLabel" aria-modal="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editOtherInfoModalLabel">Edit Other Information Record <p class="message text-end fs-11"></<p></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" class="row g-3 needs-validation" novalidate id="editOtherInfoForm">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="form-check mb-2 form-check-inline ">
                            <input class="form-check-input" type="radio" name="personally_associated_with_org" id="yes" value="yes">
                            <label class="form-check-label" for="yes">Yes</label>
                        </div>
                        <div class="form-check mb-2 form-check-inline">
                            <input class="form-check-input" type="radio" name="personally_associated_with_org" id="no" value="no">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="form-check mb-2 form-check-inline ">
                            <input class="form-check-input" type="radio" name="family_member_associated_with_org" id="yes" value="yes">
                            <label class="form-check-label" for="yes">Yes</label>
                        </div>
                        <div class="form-check mb-2 form-check-inline">
                            <input class="form-check-input" type="radio" name="family_member_associated_with_org" id="no" value="no">
                            <label class="form-check-label" for="no">No</label>
                        </div>
                        <p>If yes, please mention deails including the names and location/address (es) of those institutions;</p>
                        <div class="form-label-group in-border mt-2">
                    ...
                    <div class="col-12 text-end">
                        <button class="btn btn-primary update_other_info" type="submit">update Changes</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#editOtherInfoForm', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('save-application-other-information') }}",
                type: "POST",
                data: $('#editOtherInfoForm').serializeArray(),
                headers: {
                    'X-CSRF-Token': '{{ csrf_token() }}',
                },
                cache: false,
                success: function (data) {
                    document.getElementById("editOtherInfoForm").reset();
