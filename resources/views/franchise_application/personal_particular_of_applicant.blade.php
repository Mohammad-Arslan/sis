...
<div class="accordion-item accordion-fill-primary">
    <h2 class="accordion-header" id="personalInformation">
        <button class="accordion-button {{isset($franchise) ? 'collapsed' : ''}}" type="button" data-bs-toggle="collapse" data-bs-target="#accor_borderedcollapse1" aria-expanded="true" aria-controls="accor_borderedcollapse1">
        ...
        <div class="accordion-body">
            <div class="row">
                ...
                @if(isset($franchise))
                    <div class="col-md-4 col-sm-12  mt-3">
                        <div class="form-label-group in-border">
                            <select class="load-select form-select get-state-constituencies" id="state" name="state_id" data-target="city_id" data-url="{{ route('list-cities') }}" aria-label="State select" required>
                ...
                <div class="col-md-4 col-sm-12 mt-3">
                    <div class="form-label-group in-border">
                        <input type="number" class="form-control" id="seat_no" name="seat_no" placeholder="Seat No" value="{{ isset($franchise) ? $franchise->seat_no : old('seat_no') }}">
                ...
                <div class="col-md-4 col-sm-12 mt-3">
                    <div class="form-label-group in-border">
                        <select class="load-select form-select" id="constituency_id" name="constituency_id">
                            <option value="">Please select</option>
                            @if (isset($franchise) && isset($constituencies))
                                @foreach ($constituencies as $constituency)
                                    <option value="{{ $constituency->id }}" {{ $franchise->constituency_id == $constituency->id ? 'selected' : '' }} >{{ $constituency->name }}</option>
                                @endforeach
                            @endif
                        </select>
                        <label for="cityId" class="form-label">Constituency</label>
                        <div class="invalid-tooltip">
