<div class="accordion-item mt-3">
    <h2 class="accordion-header" id="accordionborderedDesiredFranchiseDetails">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accor_borderedcollapse4" aria-expanded="false" aria-controls="accor_borderedcollapse4" @if(!isset($franchise)) disabled @endif>
            Desired Franchise Details
        </button>
    </h2>
    <div id="accor_borderedcollapse4" class="accordion-collapse collapse" aria-labelledby="accordionborderedDesiredFranchiseDetails" data-bs-parent="#accordionBordered" style="">
            ...
            @if(isset($franchise))
                <div class="col-xl-12 col-sm-12">
                    <ul class="list-group">
                        ...
                        @include('franchise_application.possess_site_table')
