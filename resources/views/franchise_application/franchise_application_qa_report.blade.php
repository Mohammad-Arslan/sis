...
@section('content')
    ...
    <x-breadcrumb>
        ...
        <li class="breadcrumb-item active">Franchise Applications QA Report</li>
    </x-breadcrumb>

<div class="col-lg-12">
	<div class="card">
			<div class="card-header align-items-center d-flex">
					<h4 class="card-title mb-0 flex-grow-1">QA Application Report</h4>
					<div class="flex-shrink-0">
							<!-- Buttons with Label -->
                            @permission('download-pdf-franchise-app-qa')
                                <a href="{{route('franchise-application-qa.create_pdf',$franchise_application_qa->id)}}" class="btn btn-sm btn-primary" title="Download QA Report">
                                    Download PDF
                                </a>
                            @endpermission
