    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" method="POST" action="{{ route('franchise-application-bd.store') }}" novalidate>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <input type="text" class="form-control @if($errors->has('site_address')) is-invalid @endif" id="siteAddress" name="site_address" placeholder="Please enter first name" value="{{ old('site_address') }}" required>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <select class="form-select @if($errors->has('school_configuration')) is-invalid @endif" id="school_configuration" name="school_configuration" aria-label="school_configuration select" disabled required>
                                ...
                                @foreach ($class_groups as $class_group)
                                    <option value="{{ $class_group->id }}" {{ old('school_configuration') == $class_group->id ? 'selected' : '' }}>{{ $class_group->description }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <input type="text" class="form-control @if($errors->has('proposed_school_name')) is-invalid @endif" id="proposed_school_name" name="proposed_school_name" placeholder="Please enter proposed school name" value="{{ old('proposed_school_name') }}" required>
                    ...
                    {{-- <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <select class="form-select @if($errors->has('area_population_half_km_radius')) is-invalid @endif" id="area_population_half_km_radius" name="area_population_half_km_radius" aria-label="area_population_half_km_radius select" required>
                                    <option value="">Please select</option>
                                    <option value="UM" {{ old('area_population_half_km_radius') == 'UM' ? 'selected' : '' }}>UM</option>
                                    <option value="M" {{ old('area_population_half_km_radius') == 'M' ? 'selected' : '' }}>M</option>
                                    <option value="LM" {{ old('area_population_half_km_radius') == 'LM' ? 'selected' : '' }}>LM</option>
                            </select>
                    ...
                    {{-- <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <select class="form-select @if($errors->has('area_population_one_km_radius')) is-invalid @endif" id="area_population_one_km_radius" name="area_population_one_km_radius" aria-label="area_population_one_km_radius select" required>
                                    <option value="">Please select</option>
                                    <option value="UM" {{ old('area_population_one_km_radius') == 'UM' ? 'selected' : '' }}>UM</option>
                                    <option value="M" {{ old('area_population_one_km_radius') == 'M' ? 'selected' : '' }}>M</option>
                                    <option value="LM" {{ old('area_population_one_km_radius') == 'LM' ? 'selected' : '' }}>LM</option>
                            </select>
                    ...
                    {{-- <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <select class="form-select @if($errors->has('area_population_two_km_radius')) is-invalid @endif" id="area_population_two_km_radius" name="area_population_two_km_radius" aria-label="area_population_two_km_radius select" required>
                                    <option value="">Please select</option>
                                    <option value="UM" {{ old('area_population_two_km_radius') == 'UM' ? 'selected' : '' }}>UM</option>
                                    <option value="M" {{ old('area_population_two_km_radius') == 'M' ? 'selected' : '' }}>M</option>
                                    <option value="LM" {{ old('area_population_two_km_radius') == 'LM' ? 'selected' : '' }}>LM</option>
                            </select>
                      ...
                      <div class="form-label-group in-border">
                        <select class="form-select @if($errors->has('visit_by')) is-invalid @endif" id="visitBy" name="visit_by" aria-label="select" required>
                            ...
                            @foreach ($bd_reps as $bd_rep)
                                <option value="{{ $bd_rep->id }}" {{ old('visit_by') == $bd_rep->id ? 'selected' : '' }} >{{ $bd_rep->user->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 col-sm-12">
                      <div class="form-label-group in-border">
                        <select class="form-select @if($errors->has('bd_status')) is-invalid @endif" id="bdStatus" name="bd_status" aria-label="select" required>
                            <option value="pending" {{ old('bd_status') == 'pending' ? 'selected' : '' }}>Pending</option>
                            <option value="approved" {{ old('bd_status') == 'approved' ? 'selected' : '' }}>Approved</option>
                            <option value="not_approved" {{ old('bd_status') == 'not_approved' ? 'selected' : '' }}>Not Approved</option>
                        </select>
                    ...
                    <div class="col-md-4 col-sm-12">
                      <div class="form-label-group in-border">
                          <input type="text" class="form-control @if($errors->has('site_purpose')) is-invalid @endif" id="sitePurpose" name="site_purpose" placeholder="Please enter first name" value="{{ old('site_purpose') }}" required>
                      ...
                      <div class="form-label-group in-border">
                        <select class="form-select @if($errors->has('forward_to')) is-invalid @endif" id="forwardTo" name="forward_to" aria-label="select" required>
                            ...
                            @foreach ($forward_to as $emp)
                                <option value="{{ $emp->id }}" {{ old('visit_by') == $emp->id ? 'selected' : '' }} >{{ $emp->user->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <div class="input-group">
                              <input type="text" class="form-control @if($errors->has('forwarded_date')) is-invalid @endif" data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"  value="{{ old('forwarded_date') }}" name="forwarded_date" id="forwarded_date" required>
                    ...
                    <div class="col-md-4 col-sm-12">
                      <div class="form-label-group in-border">
                        <select class="form-select @if($errors->has('approved_by')) is-invalid @endif" id="approvedBy" name="approved_by" aria-label="select" required>
                            ...
                            @foreach ($bd_reps as $bd_rep)
                                <option value="{{ $bd_rep->id }}" {{ old('approved_by') == $bd_rep->id ? 'selected' : '' }} >{{ $bd_rep->user->name }}</option>
                            @endforeach
                        </select>
                        ...
                        <div class="invalid-tooltip">
                            ...
                            @else
                            Approved authority is required!
                            @endif
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="form-label-group in-border">
                            <div class="input-group">
                              <input type="text" class="form-control @if($errors->has('approval_date')) is-invalid @endif" data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"  value="{{ old('approval_date') }}" name="approval_date" id="approval_date" required>
                    ...
                    <div class="col-md-12">
                      <div class="form-label-group in-border">
                          <textarea class="form-control @if($errors->has('remarks')) is-invalid @endif" id="bdRemarks" name="remarks" rows="2" placeholder="Please enter your qa remarks" required>{{ old('remarks') }}</textarea>
