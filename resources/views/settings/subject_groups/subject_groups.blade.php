...
@section('content')
    <div class="row">
        ...
        @if (isset($subjectGroup))
            @include('settings.subject_groups.edit_subject_group')
        @else
            @permission('add-subject-group')
                @include('settings.subject_groups.add_subject_group')
            @endpermission
        @endif
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Subject Group List</h4>
                ...
                <div class="card-body">
                    ...
                    <table id="subject-groups-data-table"
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#subject-groups-data-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                bLengthChange: false,
                ...
                ajax: "{{ route('subject-groups.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id',
                        width: "5%"
