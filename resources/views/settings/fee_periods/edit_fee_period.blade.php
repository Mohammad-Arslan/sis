<div class="col-lg-12">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Edit Fee Period</h4>
        ...
        <div class="card-body">
            <div class="live-preview">
                <form class="row g-3 needs-validation" novalidate
                    action="{{ route('fee-period.update', $fee_period->id) }}" method="post">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="form-label-group in-border">
                            <input type="text" class="form-control @if ($errors->has('period_description')) is-invalid @endif"
                                ...
                                value="{{ $fee_period->period_description }}">
                                ...
                                @if (isset($companies))
                                    @foreach ($companies as $company)
                                        <option value="{{ $company->id }}"
                                            {{ $fee_period->branch->company->id == $company->id ? 'selected' : '' }}>
                                ...
                                @if (isset($branches))
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}"
                                            {{ $fee_period->branch_id == $branch->id ? 'selected' : '' }}>
                                ...
                                @if (isset($academic_years))
                                    @foreach ($academic_years as $academic_year)
                                        <option value="{{ $academic_year->id }}"
                                            {{ $fee_period->academic_year_id == $academic_year->id ? 'selected' : '' }}>
                                            {{ $academic_year->title }}
                                        </option>
                                    @endforeach
                                @endif
                            ...
                            <div class="col-md-4 col-sm-12 mt-2">
                                <div class="input-group form-label-group in-border">
                                    <input type="text"
                                        ...
                                        value="{{ $fee_period->from_date }}" name="from_date" id="fromDate" required>
                            ...
                            <div class="col-md-4 col-sm-12 mt-2">
                                <div class="input-group form-label-group in-border">
                                    <input type="text"
                                        ...
                                        data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"
                                        value="{{ $fee_period->issue_date }}" name="issue_date" id="issueDate"
                                        required>
                                    <div class="input-group-text bg-primary border-primary text-white">
                                        <i class="ri-calendar-2-line"></i>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12 mt-2">
                                <div class="input-group form-label-group in-border">
                                    <input type="text"
                                        ...
                                        data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"
                                        value="{{ $fee_period->due_date }}" name="due_date" id="dueDate" required>
                                    <div class="input-group-text bg-primary border-primary text-white">
                                        <i class="ri-calendar-2-line"></i>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12 mt-2">
                                <div class="input-group form-label-group in-border">
                                    <input type="text"
                                        ...
                                        data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"
                                        value="{{ $fee_period->valid_date }}" name="valid_date" id="validDate"
                                        required>
                                    <div class="input-group-text bg-primary border-primary text-white">
                                        <i class="ri-calendar-2-line"></i>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12 mt-2">
                                <div class="input-group form-label-group in-border">
                                    <input type="text"
                                        ...
                                        data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"
                                        value="{{ $fee_period->arrears_date }}" name="arrears_date" id="arrearsDate"
                                        required>
                                    <div class="input-group-text bg-primary border-primary text-white">
                                        <i class="ri-calendar-2-line"></i>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12 mt-2">
                                <div class="input-group form-label-group in-border">
                                    <input type="text"
                                        ...
                                        data-provider="flatpickr" data-date-format="Y-m-d" data-altFormat="d-m-Y"
                                        value="{{ $fee_period->to_date }}" name="to_date" id="toDate" required>
                                    <div class="input-group-text bg-primary border-primary text-white">
                                        <i class="ri-calendar-2-line"></i>
                                    </div>
