    ...
    <div class="row">
        ...
        @else
            @permission('add-company')
                @include('settings.companies.add_company')
            @endpermission
        @endif --}}
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <!-- Buttons with Label -->
                        <a href="{{ route('companies.create').'?tab=basic' }}" class="btn btn-success btn-label btn-sm">
                            <i class="ri-add-fill label-icon align-middle fs-16 me-2"></i> Add Company
                        </a>
                ...
                <div class="card-body">
                    <table id="company-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
