...
@include('components.flash_message')
    <div class="row">
        ...
        @if (isset($inquiry_type))
            @include('settings.inquiry_types.edit_type')
        @else
            @permission('add-inquiry-type')
                @include('settings.inquiry_types.add_type')
            @endpermission
        @endif
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Inquiry Type List</h4>
                ...
                <div class="card-body">
                    ...
                    <table id="inquiry-type-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#inquiry-type-data-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                bLengthChange: false,
