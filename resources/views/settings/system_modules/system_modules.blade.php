...
@section('content')
    <div class="row">
        ...
        @if (isset($systemModule))
            @include('settings.system_modules.edit_system_module')
        @else
            @permission('add-system-module')
                @include('settings.system_modules.add_system_module')
            @endpermission
        @endif
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">System Modules List</h4>
                ...
                <div class="card-body">
                    <table id="system-modules-data-table"
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#system-modules-data-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                bLengthChange: false,
                ...
                ajax: "{{ route('system-modules.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id',
                        width: "5%"
