...
@section('content')
    <div class="row">
        ...
        @if (isset($state))
            @include('settings.states.edit_state')
        @else
            @permission('add-state')
                @include('settings.states.add_state')
            @endpermission
        @endif
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">State List</h4>
                ...
                <div class="card-body">
                    ...
                    <table id="state-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
