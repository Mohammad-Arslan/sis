...
@include('components.flash_message')
    <div class="row">
        ...
        @if (isset($followUpType))
            @include('settings.followup_types.edit_followup_type')
        @else
            @permission('add-follow-up-type')
                @include('settings.followup_types.add_followup_type')
            @endpermission
        @endif
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Follow Up Type List</h4>
                ...
                <div class="card-body">
                    ...
                    <table id="followup-type-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#followup-type-data-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                bLengthChange: false,
