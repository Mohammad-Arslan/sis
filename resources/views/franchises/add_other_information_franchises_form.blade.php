<form class="g-3 needs-validation" action="{{ route('franchises.store') }}" method="POST"  novalidate>
	...
	<div class="row">
		<div class="col-md-4 col-sm-12  mt-3">
			...
			<input type="text" class="form-control" id="other_profession" name="other_profession" placeholder="Import Export" value="">
			<div class="valid-feedback">Looks good!</div>
		</div>
		<div class="col-md-4 col-sm-12  mt-3">
			<label for="campus_location" class="form-label">Area/Location of interest for UCS franchise</label>
			<input type="text" class="form-control" id="campus_location" name="campus_location" placeholder="Clifton , Karachi" value="">
			<div class="valid-feedback">Looks good!</div>
		</div>
		<div class="col-md-4 col-sm-12  mt-3">
		...
		<div class="col-md-4 col-sm-12  mt-3">
			...
			<div class="input-group">
				<div class="input-group-text">
					Yes&nbsp;<input class="form-check-input mt-0" type="radio" value="yes" aria-label="Radio button for following text input" name="already_franchise"> &nbsp;  &nbsp;No &nbsp;<input class="form-check-input mt-0" type="radio" value="no" aria-label="Radio button for following text input" name="already_franchise">
				</div>
				<input type="text" class="form-control remarks" aria-label="Text input with radio button" readonly>
			</div>
			<div class="valid-feedback">Looks good!</div>
		</div>
		...
		<div class="col-md-4 col-sm-12  mt-3">
			...
			<div class="form-check mt-1 mt-lg-1">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="franchise_type" id="new" value="new">
                    <label class="form-check-label" for="yes">Opening a new franchise</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="franchise_type" id="old" value="old">
