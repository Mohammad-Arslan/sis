<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <table id="employee-coordinators"
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#employee-coordinators').dataTable({
                searching: false,
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                ajax: {
                    url: "{{ route('get-employees', ['id' => $branch->id, 'desig' => 'Coordinators']) }}",
                    data: function(d) {
                        d.gender = $('#gender').val();
        ...
        $(document).on('change', '.filter', function() {
            $('#employee-coordinators').DataTable().ajax.reload(null, false);
        });
