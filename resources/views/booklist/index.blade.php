...
@section('content')
    @include('components.flash_message')
     ...
     <x-breadcrumb>
        ...
        <li class="breadcrumb-item">Booklist</li>
    </x-breadcrumb>
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Booklists</h4>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <table id="booklist-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                    style="width:100%">
                    <thead>
                        <tr>
                            <th>Document Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change', '.filter', function() {
                $('#booklist-data-table').DataTable().ajax.reload(null, false);
            });
        });
    </script>
@endpush
