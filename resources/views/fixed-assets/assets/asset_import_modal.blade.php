<div id="importAssetsModal" class="modal fade zoomIn" tabindex="-1" aria-labelledby="zoomInModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="zoomInModalLabel">Import Assets</h5>
            ...
            <div class="modal-body pb-0">
                ...
                <div class="row">
                    <div class="col-xxl-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-3 needs-validation import-assets-form"
                                    id="assetImportForm" action="{{ route('fixed-assets.assets.import') }}"
                                    ...
                                    <div class="col-12 text-end">
                                        {{-- <button type="button" class="btn btn-outline-secondary me-2" onclick="downloadImportTemplate()">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                        ...
                        <div class="alert alert-success border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0" id="successMessage">Your asset data has been processed successfully.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card border-success">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted mb-0">New Assets</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="mb-1">New Assets</h6>
                                                <p class="text-muted mb-0">
                                                    <span id="importedCountText">0</span> new assets were successfully imported
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="alert alert-info border-0 mt-3">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <ul class="mb-0 ps-3">
                                                <li>New assets with unique asset tags were successfully imported</li>
                                                <li>Assets with existing asset tags/serial numbers were automatically skipped to prevent duplicates</li>
                                                <li>Records with validation errors were skipped and logged</li>
                                                <li>All data was validated for accuracy and completeness</li>
                                                <li>The asset register has been updated with new records</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="refreshAssetTable()">
                    <i class="ri-refresh-line me-1"></i>Refresh Asset List
                </button>
            </div>
        </div>
    </div>
