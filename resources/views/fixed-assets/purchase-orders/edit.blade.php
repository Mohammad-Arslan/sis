    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Edit Purchase Order</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('fixed-assets.purchase-orders.update', $purchaseOrder->id) }}" method="POST" id="purchase-order-form">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('po_number') is-invalid @enderror" id="po_number" name="po_number" value="{{ old('po_number', $purchaseOrder->po_number) }}" required readonly>
                                @error('po_number')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('expected_delivery_date') is-invalid @enderror" id="expected_delivery_date" name="expected_delivery_date" value="{{ old('expected_delivery_date', $purchaseOrder->expected_delivery_date ? date('Y-m-d', strtotime($purchaseOrder->expected_delivery_date)) : '') }}" required min="{{ date('Y-m-d') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('department_id') is-invalid @enderror" id="department_id" name="department_id" required>
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ old('department_id', $purchaseOrder->department_id) == $department->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('payment_terms') is-invalid @enderror" id="payment_terms" name="payment_terms" value="{{ old('payment_terms', $purchaseOrder->payment_terms) }}" placeholder="e.g., Net 30, COD">
                                @error('payment_terms')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('shipping_terms') is-invalid @enderror" id="shipping_terms" name="shipping_terms" value="{{ old('shipping_terms', $purchaseOrder->shipping_terms) }}" placeholder="e.g., FOB, CIF">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('shipping_method') is-invalid @enderror" id="shipping_method" name="shipping_method" value="{{ old('shipping_method', $purchaseOrder->shipping_method) }}" placeholder="e.g., Ground, Express">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('delivery_address') is-invalid @enderror" id="delivery_address" name="delivery_address" rows="3">{{ old('delivery_address', $purchaseOrder->delivery_address) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('billing_address') is-invalid @enderror" id="billing_address" name="billing_address" rows="3">{{ old('billing_address', $purchaseOrder->billing_address) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" rows="3">{{ old('remarks', $purchaseOrder->remarks) }}</textarea>
                                @error('remarks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="discount_amount" name="discount_amount" min="0" step="0.01" value="{{ old('discount_amount', $purchaseOrder->discount_amount ?? '0.00') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="tax_amount" class="form-label">Tax Amount</label>
                                <input type="number" class="form-control" id="tax_amount" name="tax_amount" min="0" step="0.01" value="{{ old('tax_amount', $purchaseOrder->tax_amount ?? '0.00') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="shipping_cost" class="form-label">Shipping Cost</label>
                                <input type="number" class="form-control" id="shipping_cost" name="shipping_cost" min="0" step="0.01" value="{{ old('shipping_cost', $purchaseOrder->shipping_cost ?? '0.00') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12 text-end">
                            <h5>Total: <span id="grand-total">{{ number_format($purchaseOrder->total_cost, 2) }}</span></h5>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const currentUserId = {{ $purchaseOrder->user_id ?? 'null' }};
