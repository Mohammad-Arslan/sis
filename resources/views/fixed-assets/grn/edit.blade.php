    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Edit Goods Received Note</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('fixed-assets.grn.update', $grn->id) }}" method="POST" id="grn-form">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('grn_number') is-invalid @enderror" id="grn_number" name="grn_number" value="{{ old('grn_number', $grn->grn_number) }}" required readonly>
                                @error('grn_number')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('received_date') is-invalid @enderror" id="received_date" name="received_date" value="{{ old('received_date', $grn->received_date ? date('Y-m-d', strtotime($grn->received_date)) : '') }}" required>
                                @error('received_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('branch_id') is-invalid @enderror" id="branch_id" name="branch_id" required>
                                    ...
                                    @foreach($branches as $branch)
                                        <option value="{{ $branch->id }}" {{ old('branch_id', $grn->branch_id) == $branch->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('department_id') is-invalid @enderror" id="department_id" name="department_id" required>
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ old('department_id', $grn->department_id) == $department->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('delivery_note_number') is-invalid @enderror" id="delivery_note_number" name="delivery_note_number" value="{{ old('delivery_note_number', $grn->delivery_note_number) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('invoice_number') is-invalid @enderror" id="invoice_number" name="invoice_number" value="{{ old('invoice_number', $grn->invoice_number) }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" rows="3">{{ old('remarks', $grn->remarks) }}</textarea>
                                @error('remarks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <table class="table table-bordered" id="items-table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><span id="grand-total">{{ number_format($grn->total_cost, 2) }}</span></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const currentUserId = {{ $grn->user_id ?? 'null' }};
                ...
                fetch(`{{ route('fixed-assets.get-purchase-order-details') }}?purchase_order_id=${purchaseOrderId}`)
                    ...
                    .then(data => {
                        ...
                        if (po.department_id) {
                            ...
                            // Get users for this branch and department
                            getUsers();
                        }
